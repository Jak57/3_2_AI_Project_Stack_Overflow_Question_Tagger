...
def sidebar_content():
    ...
    dataset_name = st.sidebar.selectbox("Select Dataset", ("StackSample", "Breast cancer", "Wine Dataset"))
    classifier_name = st.sidebar.selectbox("Select Classifier", ("OneVsRestClassifier", "SVM", "Random Forest"))
